...
public class Oct25_Assignment {
	public static void main(String[] args) {
		...
		d1.findElement(By.cssSelector("[href='h  ttps://www.facebook.com/OrangeHRM/']")).click();
		...
		for(String id:all_id)
		{
			...
			if(!d1.getCurrentUrl().contains("https://www.linkedin.com/company/orangehrm"))
//					&& !d1.getCurrentUrl().contains("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login")) {
				d1.close();
			}
//			
		}
